...
# 13 "../Core/Src/main.c" 2





uint8_t g_au8RecData[1024] = {0};

volatile uint32_t g_u32ComRbytes = 0;
volatile uint32_t g_u32ComRhead = 0;
volatile uint32_t g_u32ComRtail = 0;
volatile int32_t g_i32Wait = (1UL) ///< Boolean 1, define to use in API parameters or return value;
...
int main()
{
 ...
 ( (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*((GPIO_PB)))) + (((GPIO_Pin3))<<2)))) = 1 );
 printf("\nStart Main loop\n");
    while (1)
 {
  ...
  //printf("\nInput: ");
  //( (*((volatile uint32_t *)(((((uint32_t)0x40000000UL) + 0x04800UL)+(0x40*((GPIO_PB)))) + (((GPIO_Pin3))<<2)))) = 1 );
  //CLK_SysTickLongDelay(1000*1000);
# 123 "../Core/Src/main.c"
 }
}
