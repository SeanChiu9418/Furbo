# 1 "../MYx/Src/MyMCU_UART.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../MYx/Src/MyMCU_UART.c" 2
...
# 13 "../MYx/Src/MyMCU_UART.c" 2

//static unsigned char uRx_Data;
unsigned char UART_CMD[64] = {0};
...
void MyUart_Init()
{
    ...
    UART_SetTimeoutCnt(((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)), 0x10); // Set Rx Time-out counter

    // Set RX FIFO Interrupt Trigger Level
    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFO &= ~ (0xful << (4));
    ((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFO |= (0x0ul << (4));
    ...
    //UART_DisableInt(((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)), ((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (4))));
...
void MyUart_RxData(uint8_t *pData, uint16_t Size)
{
  ...
  *pData = ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))->DAT);
...
void MyUart_TxData(uint8_t *pData, uint16_t Size)
{
  ...
  for (i = 0 ; i <Size; i++)
  {
   while ((((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))->FIFOSTS & (0x1ul << (23)))>>(23)));
   ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL)))->DAT = (*(pData+i)));
  }
...
void MyUart_Receive()
{
 ...
 static unsigned char uRx_Data[64] = {0} ; //存儲?���?
...
void MyUart_IRQHandler()
{
 //printf("UART0->INTSTS = %d \n",((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->INTSTS);



 if ((((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->INTSTS & (0x1ul << (8))) || (((UART_T *) ((((uint32_t)0x40000000UL) + 0x00040000UL) + 0x30000UL))->INTSTS & (0x1ul << (12))))
