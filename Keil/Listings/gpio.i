# 1 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c" 2
# 10 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
...
# 11 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c" 2
# 40 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
void GPIO_SetMode(GPIO_T *port, uint32_t u32PinMask, uint32_t u32Mode)
{
    uint32_t i;
...
# 69 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
void GPIO_EnableInt(GPIO_T *port, uint32_t u32Pin, uint32_t u32IntAttribs)
{
    port->INTTYPE |= (((u32IntAttribs >> 24UL) & 0xFFUL) << u32Pin);
    port->INTEN |= ((u32IntAttribs & 0xFFFFFFUL) << u32Pin);
}
# 89 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
void GPIO_DisableInt(GPIO_T *port, uint32_t u32Pin)
{
...
# 114 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
void GPIO_SetSlewCtl(GPIO_T *port, uint32_t u32PinMask, uint32_t u32Mode)
{
    uint32_t i;
...
# 146 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/gpio.c"
void GPIO_SetPullCtl(GPIO_T *port, uint32_t u32PinMask, uint32_t u32Mode)
{
    uint32_t i;
