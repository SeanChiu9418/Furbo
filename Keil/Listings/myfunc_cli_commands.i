# 1 "../MYx/Src/MyFunc_CLI_Commands.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../MYx/Src/MyFunc_CLI_Commands.c" 2
...
# 8 "../MYx/Src/MyFunc_CLI_Commands.c" 2
...
# 9 "../MYx/Src/MyFunc_CLI_Commands.c" 2
...
# 10 "../MYx/Src/MyFunc_CLI_Commands.c" 2

# 1 "../MYx/Inc\\MyFunc_CLI_Commands.h" 1
# 15 "../MYx/Inc\\MyFunc_CLI_Commands.h"
extern CommandEntry CommandTable[];
# 24 "../MYx/Inc\\MyFunc_CLI_Commands.h"
//uint32_t MyCLI_UnsignedCommandArgument(uint8_t argNum);
void MyCLI_RebootAction(void);
void helpAction(void);
# 12 "../MYx/Src/MyFunc_CLI_Commands.c" 2
...
CommandEntry CommandTable[] = {
  ...
  { "IO_Init", MyGPIO_Init, "", " GPIO INIT" }, { "IO_W", MyGPIO_CLI_WritePin, "uuu", " GPIO_Write ex: \"IO_W Port Pin Status\"\r\n GPIO Port Number ex: 0:PortA ~ 3:PortD \r\n GPIO Pin Number 0:Pin0 ~ 15:Pin15 \r\n GPIO Pin Status Set 0:Low 1:High" },{ "IO_R", MyGPIO_CLI_ReadPin, "uu", " GPIO_Read ex: \"IO_R Port Pin \"\r\n GPIO Port Number ex: 0:PortA ~ 3:PortD \r\n GPIO Pin Number 0:Pin0 ~ 15:Pin15 "},{ "IO_S2I", MyGPIO_CLI_Set2InputMode, "uu", " GPIO_Set2InputMode ex: \"IO_S2I Port Pin \"\r\n GPIO Port Number ex: 0:PortA ~ 3:PortD \r\n GPIO Pin Number 0:Pin0 ~ 15:Pin15 "},{ "IO_S2O", MyGPIO_CLI_Set2OutputMode, "uu", " GPIO_Set2OutputMode ex: \"IO_S2O Port Pin \"\r\n GPIO Port Number ex: 0:PortA ~ 3:PortD \r\n GPIO Pin Number 0:Pin0 ~ 15:Pin15 "},{ "Dummy", MyGPIO_Init, "", "" },
  ...
  { "PIRI", MyPIR_Init, "", "" }, { "PIRS", MyPIR_WriterRegisterValue, "", "" }, { "PIRR", MyPIR_ReadDirectLink, "", "" },
  ...
  { 0, 0, 0, 0 } // 0 action makes this a terminator
};
...
void helpAction(void)
{
  ...
  for (cmd = CommandTable; cmd->name != 0; cmd++) {
    if(!(strcmp(cmd->name,"EepromWritePage")==0 || strcmp(cmd->name,"EepromReadPage")==0 || strcmp(cmd->name,"EepromStatus")==0 || strcmp(cmd->name,"interactive")==0 || strcmp(cmd->name,"dfu")==0 || strcmp(cmd->name,"RegulateVRf")==0 || strcmp(cmd->name,"GetVRf")==0))
    {
