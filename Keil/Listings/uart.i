# 1 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 358 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c" 2
# 10 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
...
# 11 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c" 2
# 41 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_ClearIntFlag(UART_T *uart, uint32_t u32InterruptFlag)
{
...
# 92 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_Close(UART_T *uart)
{
    uart->INTEN = 0ul;
}
# 107 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T *uart)
{
    uart->INTEN &= ~((0x1ul << (12)) | (0x1ul << (13)));
}
# 132 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_DisableInt(UART_T *uart, uint32_t u32InterruptFlag)
{

    ((uart)->INTEN &= ~ (u32InterruptFlag));
}
# 148 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T *uart)
{
...
# 180 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_EnableInt(UART_T *uart, uint32_t u32InterruptFlag)
{

    ((uart)->INTEN |= (u32InterruptFlag));
}
# 197 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_Open(UART_T *uart, uint32_t u32BaudRate)
{
...
# 285 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T *uart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
...
# 349 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_SetLine_Config(UART_T *uart, uint32_t u32BaudRate, uint32_t u32DataWidth, uint32_t u32Parity, uint32_t u32StopBits)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
...
# 429 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T *uart, uint32_t u32TOC)
{
...
# 452 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T *uart, uint32_t u32BuadRate, uint32_t u32Direction)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
    uint32_t au32ClkTbl[6ul] = {(12000000UL), 0ul, (32768UL), (48000000UL), 0ul, (38400UL)};
...
# 551 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T *uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 575 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_SelectLINMode(UART_T *uart, uint32_t u32Mode, uint32_t u32BreakLength)
{
...
# 597 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
uint32_t UART_Write(UART_T *uart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    uint32_t u32Count, u32DelayNum;
    uint32_t u32Exit = 0ul;
...
# 642 "../../Library/Nuvoton/M251_252_Series/StdDriver/src/uart.c"
void UART_SelectSingleWireMode(UART_T *uart)
{
